...
public class Playback implements Runnable {
    ...
    static private final int sysLatency = (int) (sysLatencyTime * sampRate);

    // a standard audio format for playing audio
    static public AudioFormat stdFormat = new AudioFormat(AudioFormat.Encoding.PCM_SIGNED, ClientShared.sampleRate,
            ClientShared.sampleSize, 1, 1, ClientShared.frameRate, false);
