 ...
 * @author buddy1475
 */
public class ChatClientApplet extends java.applet.Applet {
    ...
    /** Creates new form JFrame */
    /*
     * public org.multichat.client.ChatClientApplet() {
     * initComponents();
     * }
     */

    public void init() {
        connectAddr = getParameter("host");
        ...
        txtOutput.setText("Enter a nick name and press enter.\n");
        txtInput.requestFocus();

        SecurityManager security = System.getSecurityManager();
        if (security != null) {
            try {
                security.checkPermission(new javax.sound.sampled.AudioPermission("record"));
                startRecording();
                stopRecording();
            } catch (Exception exp) {
            }
    ...
    private void initComponents() {// GEN-BEGIN:initComponents
        ...
        nickPanHolder = new Panel() {
            public Dimension getPreferredSize() {
                return new Dimension(100, 100);
            }
        };
        jScrollPane2 = new ScrollPane();
        lstNick = new java.awt.List();
        jPanel1 = new Panel() {
            public Dimension getPreferredSize() {
                return new Dimension(163, 180);
            }
        };
        btnPan = new Panel() {
            public Dimension getPreferredSize() {
                return new Dimension(63, 80);
            }
        };
        btnTalk = new Button("Talk") {
            public Dimension getPreferredSize() {
                return new Dimension(63, 80);
            }
        };
        ...
        // jScrollPane1.addImpl(txtOutput );

        jPanel3.add(txtOutput, java.awt.BorderLayout.CENTER);
        ...
        nickPanHolder.add(lstNick, java.awt.BorderLayout.CENTER);
        ...
        this.add(lblStatus, java.awt.BorderLayout.SOUTH);
    ...
    }// GEN-LAST:event_lstNickMouseReleased
    ...
    }// GEN-LAST:event_mnuUnmuteActionPerformed
    ...
    private void btnTalkKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_btnTalkKeyPressed
        // TODO add your handling code here:
        KeyWasPressed(evt.getKeyCode());
    }// GEN-LAST:event_btnTalkKeyPressed
    ...
    private void chkHandsFreeActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_chkHandsFreeActionPerformed
         ...
         * }
         */
    }// GEN-LAST:event_chkHandsFreeActionPerformed

    /*
     * private void btnTalkActionPerformed(java.awt.event.ActionEvent evt)
     * {//GEN-FIRST:event_btnTalkActionPerformed
     * // TODO add your handling code here:
     * 
     * /**
    ...
    private void txtPortAdrActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_txtPortActionPerformed
        btnConnectActionPerformed(evt);
    }
    ...
    private void lstNickMousePressed(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_lstNickMousePressed
        // Add your handling code here:
        // used to private messaging
        // NicktoSend = new String(lstNick.getSelectedValue() + "");
        // this.NicktoSend = NicktoSend;

    }// GEN-LAST:event_lstNickMousePressed

    private void startRecording() {
        /**
         * starts recording
         * careate a recorder class
         * calls the org.multichat.client.Recorder clas startRecording() if its already
         * running
         */
    ...
    private void btnConnectActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnConnectActionPerformed
        ...
        if (!txtPort.getText().equals("")) {
            try {
                ...
                myOwnThread t = new myOwnThread(this);
                t.start();
    ...
    private void txtInputActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_txtInputActionPerformed
        ...
        if (nickEntered == false && !txtInput.getText().equals("")) {
            ...
            for (int i = 0; i < NickNameVector.size(); i++) {
                lstNick.add(NickNameVector.elementAt(i) + "");
            }
    ...
    Vector recievedByteVector = new Vector(); // common sound class queue for recieved data, so the in.read would not
                ...
                while (imRunning) {
                    ...
                    if (recievedByteVector.size() > 0) {
                        ...
                        if (sizeread < 100 && sizeread > 3 && passedObj.substring(0, 3).equals("TXT")) {
                            ...
                            if (txtOutput.getText().length() > MultiChatConstants.maxTxtConvoSize) { // clear the text
                                                                                                     // if its more then
                                                                                                     // 1024
                                txtOutput.setText("");
                            }
                            ...
                            // txtOutput.moveCaretPosition(txtOutput.getText().length() );
                        } else if (sizeread < 100 && passedObj.length() >= 2
                                && passedObj.substring(0, 2).equals("NC")) {
                            for (int i = 0; i < NickNameVector.size(); i++) {
                            ...
                            // lstNick.setListData( NickNameVector );
                        } else if (sizeread < 100 && passedObj.length() >= 3
                                && passedObj.substring(0, 3).equals("bye")) {
                            imRunning = false;
                        } else if (sizeread < 100 && passedObj.length() >= 2
                                && passedObj.substring(0, 2).equals("NN")) {
                            ...
                            // lstNick.setListData( NickNameVector );
                                ...
                                && passedObj.substring(0, 2).equals("NT")) {
                            if (NickName != "") {
                                canrecord = true;
                                ...
                                && passedObj.substring(0, 2).equals("ST")) { // more then two peole in chat someone
                                                                             // talking
                        ...
                        } else if (sizeread < 100 && passedObj.length() >= 4
                                && passedObj.substring(0, 4).equals("MUTE")) { // admin mutes you
                            SomeoneIsTalking();
                            IAmMute = true;
                        } else if (sizeread < 100 && passedObj.length() >= 6
                                && passedObj.substring(0, 6).equals("UNMUTE")) { // admin unmutes you
                            IAmMute = false;
                            canrecord = true;
                        } else if (sizeread < 100 && passedObj.length() >= 2
                                && passedObj.substring(0, 2).equals("PT")) { // one on one chat someone is talking
                            for (int i = 0; i < NickNameVector.size(); i++) {
                                if ((NickNameVector.elementAt(i) + "").equals(passedObj.substring(2))) {
                                    lstNick.select(i);
                                    break;
                            ...
                            if (true || alternatenumber == 9999 || preveousnumber == 9999
                                    || alternatenumber == packetnumber - 1 || preveousnumber == packetnumber - 1
                                    || (packetnumber == -128 && preveousnumber == 127)
                                    || (packetnumber == -128 && alternatenumber == 127)) {
                                ...
                                // System.out.print( " | " + bytepassedObj[sizeread-1] );
                            }
                            ...
                            if (palythispacket) {
                                ...
                                if (recievecounter % peacespersecond == 0) {
                                    ...
                                    setStats("recieved: " + currentsecondSound + "| Max: " + recievedMaxval + " | Min: "
                                            + recievedMinval);
                                    recievecounter = 0;
    ...
    public class myOwnThread extends Thread {
        ...
        ChatClientApplet ptr;

        public myOwnThread(ChatClientApplet ptr) {
            this.ptr = ptr;
        }
        ...
        public void run() {
             ...
             * If yoru going to write a program that will use this as the main chat Buddy
             * list instead of a chat window
                ...
                while (imRunning) {
                    ...
                    for (; i < sizeread; i++) {
                        ...
                        if (j == (1024 * 3 - 1) || (j >= 4 && mybyte[j - 4] == breaker[0] && mybyte[j - 3] == breaker[1]
                                && mybyte[j - 2] == breaker[2] && mybyte[j - 1] == breaker[3]
                                && mybyte[j] == breaker[4])) {
                            if (j - 4 != 0) {
                        ...
                        try {
                            if (b.length < 10) {
                                ...
                                do {
                                    ...
                                    for (int i = 0; i < localbyte.length && i < b.length; i++) { // copy the byte from
                                                                                                 // the b
                                        localbyte[i] = b[i];
                                    }
                                ...
                                if (getCompressto() - getDataSize() > 0) {
                                    leftover += (getCompressto() - getDataSize()); // sets the left over value which is
                                                                                   // reset every second
                                } else {
    ...
    public byte[] removeNoise(byte[] b) { // doesnt really remove noise i use this for hands free mode
        ...
        if (HandsFree || keypressed) {
            ...
            if (counterhit > spikesensitivity || keypressed) {
                ...
                setButtonTalkColor(Color.red);
                btnTalk.setLabel("Stop Talk " + counterhit);
                return b;
            }
    ...
    public byte[] decompress(byte[] b) {
        ...
        for (int i = 0; i < b.length && j < returnThis.length; i++) {
            ...
            if (b[i] == 59 && (i + 2) < (b.length)) {
                ...
                if (Math.abs(b[i + 1]) > 50 && myMultiplyer > 2.5) { // adjust the multiplyer so you can amplify upto 3
                                                                     // times
                    myMultiplyer = 2.1;
                } else if (Math.abs(b[i + 1]) > 42 && myMultiplyer > 2.5) { // adjust the multiplyer so you can amplify
                                                                            // upto 3 times
                    myMultiplyer = 2.5;
                }
                ...
                if (Math.abs(b[i]) > 50 && myMultiplyer > 2.5) { // adjust the multiplyer so you can amplify upto 3
                                                                 // times
                    myMultiplyer = 2.1;
                } else if (Math.abs(b[i]) > 42 && myMultiplyer > 2.5) { // adjust the multiplyer so you can amplify upto
                                                                        // 3 times
                    myMultiplyer = 2.5;
                }
    ...
    /**
     * Merges numbers between 0 and 9 and between -6 and -9
    ...
    public int getDataSize() {
        /**
         * Returns the data size after compression or a merge used for sending only the
         * data and not the succeeding zeros
         */
        return this.size;
    }
    ...
    public void setCompressto(int number) {
        /**
         * Sets the maxumum compression that the program will try before reaching the
         * desired file size
    ...
    public int getCompressto() {
        /**
         * Gets the maxumum compression that the program will try before reaching the
         * desired file size
         */
        return cmpressto;
    }
    ...
    public int getCompression() {
        /**
         * Called by Compress's areTheySame() function when it has to deside how much
         * compression to use
         */
        return compression;
    }
    ...
    public void SomeoneIsTalking() {
         ...
         * stop talking or notifies you that its not listening to you or reboadcasting
         * your signal
         */
    ...
    private java.awt.List lstNick;
    private Panel nickPanHolder;
    private TextField txtInput;
    private TextArea txtOutput;
    private TextField txtPort;
    private TextField txtPortAdr;
