...
public class ChatClient extends JFrame implements Runnable, ActionListener {
    ...
    /**
     * common sound class queue for recieved data, so the in.read would not freeze
     * up during calculations.
     */
                ...
                while (true) {
                    if (recievedByteVector.size() > 0) { // Data available to process
                        ...
                        if (sizeread < 100 && sizeread > 3 && passedObj.substring(0, 3).equals("TXT")) {
                            ...
                            lstNick.setListData(NickNameVector);
                            // Logoff
                        } else if (sizeread < 10 && passedObj.length() >= 3
                            ...
                            // more then two people in chat someone talking
                                ...
                                && passedObj.substring(0, 2).equals("ST")) {
                            ...
                            // one on one chat someone is talking
                                ...
                                && passedObj.substring(0, 2).equals("PT")) {
                            for (int i = 0; i < NickNameVector.size(); i++) {
                                if ((NickNameVector.elementAt(i) + "").equals(passedObj.substring(2))) {
                                    lstNick.setSelectedIndex(i);
                                    break;
     ...
     * If you're going to write a program that will use this as the main chat Buddy
    ...
    public void run() {
        try {
            ...
            while (imRunning) {
                ...
                // System.out.println("Read up to " + (ClientShared.bytesize + offset) + "
                // bytes.");
    ...
    /**
     * stop talking - Called from inside the rum() method when the server wants you
     * to
